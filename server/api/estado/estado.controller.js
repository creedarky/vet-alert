...
// Gets a single Estado from the DB
...
export function create(req, res) {
  return Estado.create(req.body)
    .then(respondWithResult(res, 201))
    .catch(handleError(res));
}

// Upserts the given Estado in the DB at the specified ID
export function upsert(req, res) {
  if(req.body._id) {
    delete req.body._id;
  }

  return Estado.upsert(req.body, {
    where: {
      _id: req.params.id
    }
  })
