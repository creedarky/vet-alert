...
function index(req, res) {
  return _sqldb.Apoderado.findAll().then(respondWithResult(res)).catch(handleError(res));
}
...
function create(req, res) {
  return _sqldb.Apoderado.create(req.body).then(respondWithResult(res, 201)).catch(handleError(res));
}
